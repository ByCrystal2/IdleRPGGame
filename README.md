...
1-) The game starts immediately without a title screen.
2-) Click the “Upgrade” button to level up your character.
3-) You can move your character using the joystick.
4-) The attack is fully automatic, and the character can attack while moving.
5-) The character's weapon is a bow.
